...
public class StuffController {
     ...
     * 类似 RAG，给一个上下文文档，大模型根据上下文文档回答用户问题。
     */
    @GetMapping(value = "/stuff/generate")
    public Flux<String> completion(
        @RequestParam(value = "message", required = false, defaultValue = "Which athletes won the mixed doubles gold medal in curling at the 2022 Winter Olympics?'") String message,
